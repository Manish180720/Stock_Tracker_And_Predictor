            ...
            <div className="mx-auto max-w-7xl px-4">
                ...
                <div className="flex flex-col space-y-8 pb-10 pt-12 md:pt-24">
                    ...
                    <p className="mx-auto max-w-4xl text-center text-base text-gray-600 md:text-xl">
                        Our users are at the heart of everything we do, and we're committed to providing the best possible experience. If you have a story to share or feedback to provide, please don't hesitate to reach out.
                    </p>
                </div>
                            ...
                            <div className="px-2 md:px-12">
                                ...
                                <form action="" className="mt-8 space-y-4">
                                    ...
                                    <div className="grid w-full  items-center gap-1.5">
                                        ...
                                        <textarea
                                            className="flex h-50 w-full rounded-md border border-gray-300 bg-transparent px-3 py-2 text-sm placeholder:text-gray-400 focus:outline-none focus:ring-1 focus:ring-gray-400 focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50 dark:border-gray-700 dark:text-gray-50 dark:focus:ring-gray-400 dark:focus:ring-offset-gray-900"
                                            id="message"
